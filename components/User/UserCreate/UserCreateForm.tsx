...
const LeadCreateForm: React.FC<UserCreateFormProps> = ({ product, form, loading, onFinish, onCancel }) => {
    ...
    return (
        <Form
            ...
            labelAlign="left"
        >
            <Title level={5} style={{ color: '#2699FB', marginBottom: 30 }}>ข้อมูล User</Title>
