...
import { OrganizationCreateFormProps } from '../interface'
...
const OrganizationCreateForm: React.FC<OrganizationCreateFormProps> = ({ product, form, loading, onFinish, onCancel }) => {
    ...
    return (
        <Form
            ...
            labelAlign="left"
        >
            <Title level={5} style={{ color: '#2699FB', marginBottom: 30, marginTop: 0 }}>ข้อมูลหน่วยงาน</Title>
            ...
            <Row  align='middle' >
                <Col span={4}>
                <Title level={5} style={{ color: '#2699FB', marginBottom: 10, marginTop: 10 }}>ข้อมูล Owner</Title>
                </Col>
                <Col span={20}>
